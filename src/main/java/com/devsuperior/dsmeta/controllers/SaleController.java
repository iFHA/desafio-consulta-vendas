...
public class SaleController {
	...
	public ResponseEntity<Page<SaleReportDTO>> getReport(@RequestParam(defaultValue = "") String minDate, @RequestParam(defaultValue = "") String maxDate, @RequestParam(defaultValue = "") String name, Pageable pageable) {
		return ResponseEntity.ok(service.searchSaleByPeriodAndSellerName(minDate, maxDate, name, pageable));
	}
	...
	public ResponseEntity<List<SaleSummaryDTO>> getSummary(@RequestParam(defaultValue = "") String minDate, @RequestParam(defaultValue = "") String maxDate) {
		return ResponseEntity.ok(service.getSaleSummaryBySeller(minDate, maxDate));
	}
}
